                                                     ...
                                                     const prach_occasion_info&  mac_pdu)
{
  ...
  builder.set_maintenance_v3_basic_parameters(mac_pdu.handle,
                                              context,
                                              prach_res_config_index,
                                              mac_pdu.nof_fd_ra,
                                              mac_pdu.start_preamble_index,
                                              mac_pdu.nof_preamble_indexes);
  builder.set_rx_port_attribution_parameters(mac_pdu.enable_rx_port_attribution,
                                             mac_pdu.rx_port_attribution_unique_margin_dB);
  builder.set_ntn_calendar_position(
      mac_pdu.calendar_position_valid,
      mac_pdu.calendar_cycle_index,
      mac_pdu.occasion_offset_us,
      mac_pdu.calendar_schedule_version);
}
