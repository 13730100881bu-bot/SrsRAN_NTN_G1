...
fapi_to_mac_data_msg_fastpath_translator::fapi_to_mac_data_msg_fastpath_translator(subcarrier_spacing scs_,
                                                                                   unsigned           sector_id_) :
  scs(scs_),
...
void fapi_to_mac_data_msg_fastpath_translator::on_rx_data_indication(const fapi::rx_data_indication_message& msg)
{
...
void fapi_to_mac_data_msg_fastpath_translator::on_crc_indication(const fapi::crc_indication_message& msg)
{
...
void fapi_to_mac_data_msg_fastpath_translator::on_uci_indication(const fapi::uci_indication_message& msg)
{
...
void fapi_to_mac_data_msg_fastpath_translator::on_srs_indication(const fapi::srs_indication_message& msg)
{
...
void fapi_to_mac_data_msg_fastpath_translator::set_cell_rach_handler(mac_cell_rach_handler& mac_rach_handler)
{
  rach_handler = &mac_rach_handler;
}

void fapi_to_mac_data_msg_fastpath_translator::set_cell_pdu_handler(mac_pdu_handler& handler)
{
  pdu_handler = &handler;
}

void fapi_to_mac_data_msg_fastpath_translator::set_cell_crc_handler(mac_cell_control_information_handler& handler)
{
